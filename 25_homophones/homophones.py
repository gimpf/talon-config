# taken from https://github.com/knausj85/knausj_talon/blob/master/code/homophones.py
...
class Actions:
    ...
    def homophones_show(m: str):
        """Show homophone selection for string"""
        raise_homophones(m, False, False)

    def homophones_show_for_selection(m: str):
        """Show homophone selection for string, allowing for quick-replace"""
        raise_homophones(m, False, True)
